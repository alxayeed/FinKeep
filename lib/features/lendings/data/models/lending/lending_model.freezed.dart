...
mixin _$LendingModel {
  ...
  String get userId;
  List<RepaymentModel>? get repayments;
  ...
  $LendingModelCopyWith<LendingModel> get copyWith =>
      _$LendingModelCopyWithImpl<LendingModel>(
          this as LendingModel, _$identity);
...
abstract mixin class $LendingModelCopyWith<$Res> {
  factory $LendingModelCopyWith(
          LendingModel value, $Res Function(LendingModel) _then) =
      _$LendingModelCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      LendingType type,
...
/// @nodoc
class _$LendingModelCopyWithImpl<$Res> implements $LendingModelCopyWith<$Res> {
    ...
    return _then(_self.copyWith(
      ...
      userId: null == userId
          ...
          : userId // ignore: cast_nullable_to_non_nullable
              as String,
      repayments: freezed == repayments
          ? _self.repayments
          : repayments // ignore: cast_nullable_to_non_nullable
...
extension LendingModelPatterns on LendingModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LendingModel value)? $default, {
...
class _LendingModel extends LendingModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LendingModelCopyWith<_LendingModel> get copyWith =>
      __$LendingModelCopyWithImpl<_LendingModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$LendingModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.userId, userId) || other.userId == userId) &&
            const DeepCollectionEquality()
                .equals(other._repayments, _repayments));
  }
  ...
  int get hashCode => Object.hash(
      ...
      status,
      userId,
      const DeepCollectionEquality().hash(_repayments));
...
/// @nodoc
abstract mixin class _$LendingModelCopyWith<$Res>
    implements $LendingModelCopyWith<$Res> {
  factory _$LendingModelCopyWith(
          _LendingModel value, $Res Function(_LendingModel) _then) =
      __$LendingModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
