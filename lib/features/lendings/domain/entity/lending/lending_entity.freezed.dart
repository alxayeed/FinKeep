...
mixin _$LendingEntity {
 ...
 String get id; LendingType get type; String get personId; LendingPersonEntity get person; double get amount; double get repaidAmount; String? get description; DateTime get createdDate; DateTime? get dueDate; LendingStatus get status; PaymentType get paymentMethod; List<RepaymentEntity>? get repayments;
...
@override
int get hashCode => Object.hash(runtimeType,id,type,personId,person,amount,repaidAmount,description,createdDate,dueDate,status,paymentMethod,const DeepCollectionEquality().hash(repayments));

@override
String toString() {
  return 'LendingEntity(id: $id, type: $type, personId: $personId, person: $person, amount: $amount, repaidAmount: $repaidAmount, description: $description, createdDate: $createdDate, dueDate: $dueDate, status: $status, paymentMethod: $paymentMethod, repayments: $repayments)';
}
...
@useResult
$Res call({
 String id, LendingType type, String personId, LendingPersonEntity person, double amount, double repaidAmount, String? description, DateTime createdDate, DateTime? dueDate, LendingStatus status, PaymentType paymentMethod, List<RepaymentEntity>? repayments
});
...
as LendingStatus,paymentMethod: null == paymentMethod ? _self.paymentMethod : paymentMethod // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  LendingType type,  String personId,  LendingPersonEntity person,  double amount,  double repaidAmount,  String? description,  DateTime createdDate,  DateTime? dueDate,  LendingStatus status,  PaymentType paymentMethod,  List<RepaymentEntity>? repayments)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LendingEntity() when $default != null:
return $default(_that.id,_that.type,_that.personId,_that.person,_that.amount,_that.repaidAmount,_that.description,_that.createdDate,_that.dueDate,_that.status,_that.paymentMethod,_that.repayments);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  LendingType type,  String personId,  LendingPersonEntity person,  double amount,  double repaidAmount,  String? description,  DateTime createdDate,  DateTime? dueDate,  LendingStatus status,  PaymentType paymentMethod,  List<RepaymentEntity>? repayments)  $default,) {final _that = this;
switch (_that) {
case _LendingEntity():
return $default(_that.id,_that.type,_that.personId,_that.person,_that.amount,_that.repaidAmount,_that.description,_that.createdDate,_that.dueDate,_that.status,_that.paymentMethod,_that.repayments);case _:
  throw StateError('Unexpected subclass');
...
@override
int get hashCode => Object.hash(runtimeType,id,type,personId,person,amount,repaidAmount,description,createdDate,dueDate,status,paymentMethod,const DeepCollectionEquality().hash(_repayments));
