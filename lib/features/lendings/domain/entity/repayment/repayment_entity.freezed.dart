...
mixin _$RepaymentEntity {
  ...
  $RepaymentEntityCopyWith<RepaymentEntity> get copyWith =>
      _$RepaymentEntityCopyWithImpl<RepaymentEntity>(
          this as RepaymentEntity, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RepaymentEntity &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.lendingId, lendingId) ||
                other.lendingId == lendingId) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, lendingId, userId, amount, paidDate, notes);
...
abstract mixin class $RepaymentEntityCopyWith<$Res> {
  factory $RepaymentEntityCopyWith(
          RepaymentEntity value, $Res Function(RepaymentEntity) _then) =
      _$RepaymentEntityCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String lendingId,
    ...
    return _then(_self.copyWith(
      id: null == id
          ...
          : id // ignore: cast_nullable_to_non_nullable
              as String,
      lendingId: null == lendingId
          ? _self.lendingId
          : lendingId // ignore: cast_nullable_to_non_nullable
              as String,
      userId: null == userId
          ? _self.userId
...
extension RepaymentEntityPatterns on RepaymentEntity {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RepaymentEntity value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _RepaymentEntity() when $default != null:
        return $default(_that.id, _that.lendingId, _that.userId, _that.amount,
            _that.paidDate, _that.notes);
      case _:
        return orElse();
    }
  }
...
class _RepaymentEntity implements RepaymentEntity {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RepaymentEntityCopyWith<_RepaymentEntity> get copyWith =>
      __$RepaymentEntityCopyWithImpl<_RepaymentEntity>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RepaymentEntity &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.lendingId, lendingId) ||
                other.lendingId == lendingId) &&
            (identical(other.userId, userId) || other.userId == userId) &&
...
/// @nodoc
abstract mixin class _$RepaymentEntityCopyWith<$Res>
    implements $RepaymentEntityCopyWith<$Res> {
  factory _$RepaymentEntityCopyWith(
          _RepaymentEntity value, $Res Function(_RepaymentEntity) _then) =
      __$RepaymentEntityCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
