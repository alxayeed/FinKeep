...
class ExpenseCategorySettingsScreen extends StatefulWidget {
  const ExpenseCategorySettingsScreen({super.key});

  @override
  State<ExpenseCategorySettingsScreen> createState() => _ExpenseCategorySettingsScreenState();
}

class _ExpenseCategorySettingsScreenState extends State<ExpenseCategorySettingsScreen> {
  final ExpenseCategoryController categoryController = Get.find();
  final TextEditingController _labelController = TextEditingController();
  final TextEditingController _emojiController = TextEditingController(text: '🛍️');
      ...
      if (mounted) {
        showDialog(
          ...
          builder: (ctx) => CustomAlertDialog(
            ...
            description: 'You can create a maximum of ${categoryController.maxCustomCategoryLimit} custom expense categories. Please delete an existing custom category to add a new one.',
            buttonText: 'Got It',
          ),
        );
      }
