...
class IncomeCategoryFilterPills extends StatefulWidget {
  final String? selectedCategoryId;
  final ValueChanged<String?> onCategorySelected;
  final String searchQuery;
  final ValueChanged<String> onSearchQueryChanged;

  const IncomeCategoryFilterPills({
    super.key,
  ...
  @override
  State<IncomeCategoryFilterPills> createState() => _IncomeCategoryFilterPillsState();
}

class _IncomeCategoryFilterPillsState extends State<IncomeCategoryFilterPills> {
  ...
  @override
  void didUpdateWidget(IncomeCategoryFilterPills oldWidget) {
  ...
  Widget _buildCategoryListWithSearchButton(BuildContext context, bool isDark) {
    return Obx(() {
      // Gather active categories, adding a null (for "All") choice
